...
<head>
  ...
  <style>
    /* Make the body the ultimate flex shell */
    body { 
      margin: 0; 
      padding: 0; 
      overflow: hidden; 
      ...
      height: 100vh; 
      padding-top: 58px; /* Offsets your fixed navbar */
      box-sizing: border-box; 
    }
    
    /* Layout dynamically fills the remaining space */
    .doc-layout  { flex: 1; display: flex; flex-direction: column; overflow: hidden; }
    
    /* Topbar shouldn't shrink or collapse */
    ...
    .doc-editor-wrap { flex: 1; display: flex; flex-direction: column; overflow: hidden; background: #fff; }
    
    /* Force Quill container to fill space */
    .doc-editor-wrap .ql-container { flex: 1; overflow-y: auto !important; height: auto !important; font-size: 16px; line-height: 1.8; }
...
<?php if ($can_edit): ?>
<form method="POST" action="document_editor.php?id=<?php echo $doc['id']; ?>" id="docForm" style="margin: 0; flex-shrink: 0;">
...
<?php else: ?>
<div class="doc-topbar" style="flex-shrink: 0;">
  <div class="doc-title"><?php echo htmlspecialchars($doc['title']); ?></div>
  <span style="font-size:12px;color:var(--text-muted);">by <?php echo htmlspecialchars($doc['owner_name']); ?></span>
